...
import { Play, Clock, ArrowRight, Activity, Database, Hash, Pause, Zap, X, AlertTriangle, Send, Layout, AlertOctagon, Film, Code } from 'lucide-react';
    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden font-sans text-gray-900">
      ...
      <div className="w-16 bg-white border-r border-gray-200 flex flex-col items-center py-6 gap-6 z-20 shadow-sm">
        ...
        <button
          ...
          className={`p-3 rounded-xl transition-all ${activeTab === 'chaos' ? 'bg-gray-900 text-white shadow-lg' : 'text-gray-400 hover:bg-gray-100'}`}
          title="Chaos Mode"
        >
        ...
        <button
          ...
          className={`p-3 rounded-xl transition-all ${activeTab === 'rules' ? 'bg-gray-900 text-white shadow-lg' : 'text-gray-400 hover:bg-gray-100'}`}
          title="Traffic Rules"
        >
          <Code size={20} />
        </button>
...

      {
        activeTab === 'rules' ? (
          <div className="flex-1 bg-gray-900">
            <Rules subdomain={SUBDOMAIN!} secureId={secureId!} socket={socket} />
          </div>
        ) : activeTab === 'recorder' ? (
